...
struct Page *ppages;		/* Array of all Page structures */
...
//
void
check_boot_page_directory(void)
{
...
///END
	...
	//////////////////////////////////////////////////////////////////////
	// Make 'ppage' point to an array of size 'nppage' of 'struct Page'.   
...
///SOL2
	printf("nppage %ld, Page_sizeof %u\n", nppage, (u_int)sizeof(struct Page));
	ppages = ptspace_alloc(&ppage_upt, nppage * sizeof(struct Page));
...
int
ppage_insert(Pde *pgdir, struct Page *pp, u_int va, u_int perm) 
{
	// Fill this function in
///SOL2
	Pte *ptep;
