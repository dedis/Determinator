...
pmap_init(void)
{
	if (cpu_onboot()) {
		...
		for (i = PDX(PMAP_USERLO); i < PDX(PMAP_USERHI); i++)
...
{
	pmap_remove(pdir, PMAP_USERLO, PMAP_USERHI-PMAP_USERLO);
